						...
						function unFollowUser(bizId) {
                            ...
                            $.post("unFollowUser.php", {bizId: bizId,search_subscribe:'Y'})
                                    .done(function(data) {
										//alert(data);
										$('#fancyboxloading_up').css('display','none');
										$("#subscribe_" + userId + bizId).css('background','linear-gradient(to bottom, #208ED3 0%, #0272BD 100%) repeat scroll 0 0 transparent');
								
                                $("#subscribe_" + userId + bizId).attr("class", "blue");
                                //$("#subscribe_" + userId + bizId).html('UNSUBSCRIBED');
								$("#subscribe_" + userId + bizId).html('SUBSCRIBE');
            ...
            <div class="widget-container">
                <section class="widget small" style="width:100%;">
                    ...
                    <div >
                        ...
                        <?php
						if(isset($_REQUEST['top_search_content']) && $_REQUEST['top_search_content']){
							$search_value = $_REQUEST['top_search_content'];
							?>
                            <script>
                            $(document).ready(function() {
						...
						?>
                           <input type="text" name="search_content" id="search_content" placeholder="Enter search text." value="<?php if(isset($search_value)){ echo $search_value;}?>">
                        </div>
                        <button id="search_button" onclick="search_subscription();" class="blue">Search</button>
                        </div>

...
$post_id = $msgManager->postNewslet($userId, $message);
//print_r($_REQUEST);
//echo $message;
...
<p align="justify"><strong>'.$_SESSION['username'].' : <br></strong>
'.$message1.'
<br><br><span style="width: 100px; margin-left: 15px; margin-right: 15px;">

        ...
        <section class="content">
            <div class="widget-container">
                <section class="widget small">
                    ...
                    ?><form action="updateUser.php" method="post" id="update_profile_form">
                        ...
                        <div class="content no-padding ">
                            ...
                            <div class="field-wrap">
                                <div class="form-row">Email :<?php if(isset($_GET['msg'])) echo '&nbsp;&nbsp;<font color=red>'.$_GET['msg'].'</font>'; ?> </div><input type="text" name="EMAIL" id="email_field" value="<?php echo $user_info['EMAIL'];?>">
...
<script type="text/javascript">
										...
										$(document).ready(function(){
											$("#update_profile_form").submit(function(){
												...
												if(regex.test($("#email_field").attr("value"))){
													return true;
												} else {
													$("#e_err").css('color','#F00');
													$("#e_err").html('Please provide a valid email address.');
													$("#email_field").focus();
													return false
												}
											})

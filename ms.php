...
<tr>
	...
	<td width="55%"><textarea name="t1" rows="7" cols="70"><?php echo stripslashes($_POST[t1])?></textarea></td>
	<td width="32%">
		...
		{
		?><option value="<?php echo $rec_show_all[0]?>" <?php echo ($rec_show_all[0] == $_POST['table_name'])?'SELECTED':'';?>><?php echo $rec_show_all[0]?></option><?php
		}
...
<br>
	...
	function show_table($rs)
	{
		...
		<tr bgcolor="#99FF99" >
		<?php	for( $i=0;$i<$kk;$i++) echo "<td><b><font color='#000000' size='-1' face='Courier New, Courier, mono'>".mysql_field_name($rs, $i)."</font></b></td>";	?>

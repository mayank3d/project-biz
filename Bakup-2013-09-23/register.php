...
<html lang="">
	...
	.error {
        ...
        <section>
            ...
            <div class="error" id="top_err"></div>
            ...
            <input type="hidden" name="action" value="registration">
                ...
                <input type="text" value="Username" id="name" name="name"/>
                ...
                <input value="passwora" type="password" id="checkPassword" name="checkPassword"/>
        ...
        <script type="text/javascript">
                    function checkUserName() {
						...
						if(username.search(/\S/)==-1 || username=='Username' || username=='username'){
							...
							$.post("validateUsername.php", {username: username,action:'check_username'})
									.done(function(data) {
										//alert(data);
						...
						if(document.registration_frm.fullname.value.search(/\S/)==-1 || document.registration_frm.fullname.value == 'Full Name'){
							...
							$.post("validateUsername.php",frm_rec)
								...
								if ($.trim(data) == "1") {
									...
									$("#top_err").html('You have registered successfully.');
									setTimeout('document.location.href="NewsStream.php";',2000);

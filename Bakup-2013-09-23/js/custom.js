$(document).ready(function() {
	...
	$(".dropdown:has(ul)").click(function() {
		
		//var display_chk = $('ul.notice').css('display');
		var display_chk = $(this).children('ul.notice').css('display');
		//alert(display_chk);
		if(display_chk == 'none'){
			$(this).find("ul").stop("true", "true").slideDown(500);
		}else{
	...
	$(".dropdown1:has(ul)").click(function() {
		
		//var display_chk = $('ul.notice').css('display');
		
		var display_chk_log = $(this).children('ul.notice_logout').css('display');
		if(display_chk_log == 'none'){
			$(this).find("ul").stop("true", "true").slideDown(500);
		}else{
			$(this).find("ul").stop("true", "true").slideUp(500);
		}

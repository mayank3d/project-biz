...
<html lang="">
    ...
    <body>
                ...
                <table id="myTable" border="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <div style=" text-align:left; margin-left:10px; margin-bottom:8px; vertical-align:middle; font-size:18px; padding:10px;">Pending Subscribers </div>                            
                            </th>
                        </tr>
                        <tr>
                            <th class="avatar" style="padding:0px;" width="40%">
                            <div style=" text-align:center; margin-bottom:8px; vertical-align:middle;">
                            Full Name</div></th>
                    ...
                    <tbody>
                        ...
                        echo $businessManager->getPendingFollowers($_SESSION['userId']);
                        ?>
		...
		/*$(document).ready(function() {
                        ...
                        function allow(bizId) {
							$('#fancyboxloading_up').css('display','block');
                            $.post("allow.php", {bizId: bizId})
                                    .done(function(data) {
                                //alert(data);
